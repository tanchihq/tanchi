...
const PipelineColumn = ({
  ...
  <div
    ...
    style={{
      background: over ? 'var(--app-accent-bg)' : 'var(--app-surface)',
  ...
  >
    <div className="flex items-center justify-between gap-2 px-[13px] pb-2.5 pt-3">
      <div className="flex items-center gap-[7px]">
        <span className="whitespace-nowrap text-[13px] font-medium tracking-tight text-app-fg">
          {STAGE_LABEL[stage]}
        </span>
    ...
    <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto px-2.5 pb-3">
      ...
      {cards.length === 0 && (
        <div className="rounded-[10px] border border-dashed border-app-line px-2.5 py-4 text-center text-[11.5px] text-app-faint">
          {emptyHint}
        </div>
      )}
    </div>
